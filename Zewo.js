const Discord = require("discord.js");//Zewo
const client = new Discord.Client();//Zewo
const ayarlar = require("./ayarlar.json");//Zewo
const fs = require("fs");//Zewo
const moment = require("moment");//Zewo
moment.locale("tr")//Zewo
const chalk = require("chalk");//Zewo
require("./util/eventLoader")(client);//Zewo
const express = require("express");//Zewo
const app = express();//Zewo
const http = require("http");//Zewo
//Zewo
